...
@section('title')
    <title>{{$user->first_name}} {{$user->last_name}} : Posts</title>
@endsection
@section('css')
...
@section('content')
    <div class="row mt-4">
        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">{{$user->first_name}} {{$user->last_name}}'s Posts</h5>
                    <hr>
                    <div class="row"
                         id="my-posts">
        ...
        const manage_posts = new Vue({
            ...
            methods: {
                loadPosts: async function () {
                    ...
                    nProgress.start();
                    try {
                        const response = await axios.post(`{{route('post.list')}}?user={{$user->id}}&limit=${this.limit}&start_post=${this.start_post}`);
